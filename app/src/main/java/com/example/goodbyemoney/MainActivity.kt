...
import com.example.goodbyemoney.pages.*
                        ...
                        if (showBottomBar) {
                            NavigationBar(containerColor = TopAppBarBackground) {
                                NavigationBarItem(
                                    ...
                                    icon = {
                                        Icon(
                                            painterResource(id = com.example.goodbyemoney.R.drawable.upload),
                                ...
                                NavigationBarItem(
                                    ...
                                    icon = {
                                        Icon(
                                            painterResource(id = com.example.goodbyemoney.R.drawable.bar_chart),
                                ...
                                NavigationBarItem(
                                    ...
                                    icon = {
                                        Icon(
                                            painterResource(id = com.example.goodbyemoney.R.drawable.add),
                                ...
                                NavigationBarItem(
                                    ...
                                    icon = {
                                        Icon(
                                            painterResource(id = com.example.goodbyemoney.R.drawable.settings_outlined),
